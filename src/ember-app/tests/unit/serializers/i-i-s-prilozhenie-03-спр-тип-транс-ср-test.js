...
moduleForModel('i-i-s-prilozhenie-03-спр-тип-транс-ср', 'Unit | Serializer | i-i-s-prilozhenie-03-спр-тип-транс-ср', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-prilozhenie-03-спр-тип-транс-ср',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
